            ...
            <div class="col-lg-9 offset-lg-1">
                <form action="{{ route('itemUoM.update', ['id' => $itemuom->itemUoMId]) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <select class="form-select" name="jenis_satuan" aria-label="Default select example">
                                ...
                                @foreach($uomtypes as $typeOUI)
                                    <option value="{{ $typeOUI->uomTypeId }}" {{ $typeOUI->uomTypeId == $itemuom->uomTypeId ? 'selected' : '' }}>
                                        {{ $typeOUI->uomType }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="satuan_barang" value="{{ $itemuom->uomItem }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-lg-3 col-form-label">Keterangan:</label>
                        <div class="col-lg-9">
                            <textarea rows="3" cols="3" class="form-control" name="keterangan">{{ $itemuom->description }}</textarea>
                        </div>
                    </div>
                    <div class="text-end">
