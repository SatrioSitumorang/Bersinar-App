...
<div class="card">
	<div class="card-header">
		<h5 class="mb-0">Detail Currency</h5>
	</div>
    ...
    <div class="row">
							...
							<form action="#">
								<div class="row mb-3">
									<label class="col-lg-3 col-form-label fw-semibold">Kode Currency:</label>
									<label class="col-lg-9 col-form-label">Kode Currency</label>
								</div>

								<div class="row mb-3">
									<label class="col-lg-3 col-form-label fw-semibold">Currency:</label>
									<label class="col-lg-9 col-form-label">Currency</label>
								</div>
