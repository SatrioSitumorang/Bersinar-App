...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Tambah Jenis Unit Bisnis</h5>
        </div>
        <div class="card-body border-top">
            <div class="row">
                <div class="col-lg-9 offset-lg-1">
                    <form action="{{ route('businessUnitTypes.store') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Jenis Unit Bisnis: </label>
                            <div class="col-lg-9">
