...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Tambah Account Category</h5>
        </div>
            ...
            <div class="row">
                <div class="col-lg-9 offset-lg-1">
                    <form action="{{ route('accountCategory.store') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="row mb-3">
                            <label class="col-lg-3 col-form-label">Kategori Rekening:</label>
                            <div class="col-lg-9">
                                <input type="text" class="form-control" placeholder="Masukkan Kategori Rekening" required name="accountCategory">
                            </div>
                        </div>
